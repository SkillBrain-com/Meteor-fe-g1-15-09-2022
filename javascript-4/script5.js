...
console.log(`cea mai mare reducere o are articolul ${BAZA_DE_DATE[pozitie].nume} cu o reducere de ${ceaMaiMareReducere} avand un pret final de ${BAZA_DE_DATE[pozitie].pret - ceaMaiMareReducere}`);